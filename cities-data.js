...
const CITIES_DATABASE = {
    ...
    'north-america': {
        capitals: [
            ...
            // US State Capitals
            { name: 'Montgomery', nameOriginal: 'Montgomery', country: 'Alabama', countryOriginal: 'Alabama', lat: 32.3668, lng: -86.3000 },
            { name: 'Juneau', nameOriginal: 'Juneau', country: 'Alaska', countryOriginal: 'Alaska', lat: 58.3019, lng: -134.4197 },
            { name: 'Phoenix', nameOriginal: 'Phoenix', country: 'Arizona', countryOriginal: 'Arizona', lat: 33.4484, lng: -112.0740 },
            { name: 'Little Rock', nameOriginal: 'Little Rock', country: 'Arkansas', countryOriginal: 'Arkansas', lat: 34.7465, lng: -92.2896 },
            { name: 'Sacramento', nameOriginal: 'Sacramento', country: 'California', countryOriginal: 'California', lat: 38.5816, lng: -121.4944 },
            { name: 'Denver', nameOriginal: 'Denver', country: 'Colorado', countryOriginal: 'Colorado', lat: 39.7392, lng: -104.9903 },
            { name: 'Hartford', nameOriginal: 'Hartford', country: 'Connecticut', countryOriginal: 'Connecticut', lat: 41.7658, lng: -72.6734 },
            { name: 'Dover', nameOriginal: 'Dover', country: 'Delaware', countryOriginal: 'Delaware', lat: 39.1582, lng: -75.5244 },
            { name: 'Tallahassee', nameOriginal: 'Tallahassee', country: 'Florida', countryOriginal: 'Florida', lat: 30.4383, lng: -84.2807 },
            { name: 'Atlanta', nameOriginal: 'Atlanta', country: 'Georgia', countryOriginal: 'Georgia', lat: 33.7490, lng: -84.3880 },
            { name: 'Honolulu', nameOriginal: 'Honolulu', country: 'Hawaii', countryOriginal: 'Hawaii', lat: 21.3099, lng: -157.8581 },
            { name: 'Boise', nameOriginal: 'Boise', country: 'Idaho', countryOriginal: 'Idaho', lat: 43.6150, lng: -116.2023 },
            { name: 'Springfield', nameOriginal: 'Springfield', country: 'Illinois', countryOriginal: 'Illinois', lat: 39.7817, lng: -89.6501 },
            { name: 'Indianapolis', nameOriginal: 'Indianapolis', country: 'Indiana', countryOriginal: 'Indiana', lat: 39.7684, lng: -86.1581 },
            { name: 'Des Moines', nameOriginal: 'Des Moines', country: 'Iowa', countryOriginal: 'Iowa', lat: 41.5868, lng: -93.6250 },
            { name: 'Topeka', nameOriginal: 'Topeka', country: 'Kansas', countryOriginal: 'Kansas', lat: 39.0473, lng: -95.6752 },
            { name: 'Frankfort', nameOriginal: 'Frankfort', country: 'Kentucky', countryOriginal: 'Kentucky', lat: 38.2009, lng: -84.8733 },
            { name: 'Baton Rouge', nameOriginal: 'Baton Rouge', country: 'Louisiana', countryOriginal: 'Louisiana', lat: 30.4515, lng: -91.1871 },
            { name: 'Augusta', nameOriginal: 'Augusta', country: 'Maine', countryOriginal: 'Maine', lat: 44.3106, lng: -69.7795 },
            { name: 'Annapolis', nameOriginal: 'Annapolis', country: 'Maryland', countryOriginal: 'Maryland', lat: 38.9784, lng: -76.4922 },
            { name: 'Boston', nameOriginal: 'Boston', country: 'Massachusetts', countryOriginal: 'Massachusetts', lat: 42.3601, lng: -71.0589 },
            { name: 'Lansing', nameOriginal: 'Lansing', country: 'Michigan', countryOriginal: 'Michigan', lat: 42.7325, lng: -84.5555 },
            { name: 'Saint Paul', nameOriginal: 'Saint Paul', country: 'Minnesota', countryOriginal: 'Minnesota', lat: 44.9537, lng: -93.0900 },
            { name: 'Jackson', nameOriginal: 'Jackson', country: 'Mississippi', countryOriginal: 'Mississippi', lat: 32.2988, lng: -90.1848 },
            { name: 'Jefferson City', nameOriginal: 'Jefferson City', country: 'Missouri', countryOriginal: 'Missouri', lat: 38.5767, lng: -92.1735 },
            { name: 'Helena', nameOriginal: 'Helena', country: 'Montana', countryOriginal: 'Montana', lat: 46.5891, lng: -112.0391 },
            { name: 'Lincoln', nameOriginal: 'Lincoln', country: 'Nebraska', countryOriginal: 'Nebraska', lat: 40.8136, lng: -96.7026 },
            { name: 'Carson City', nameOriginal: 'Carson City', country: 'Nevada', countryOriginal: 'Nevada', lat: 39.1638, lng: -119.7674 },
            { name: 'Concord', nameOriginal: 'Concord', country: 'New Hampshire', countryOriginal: 'New Hampshire', lat: 43.2081, lng: -71.5376 },
            { name: 'Trenton', nameOriginal: 'Trenton', country: 'New Jersey', countryOriginal: 'New Jersey', lat: 40.2206, lng: -74.7597 },
            { name: 'Santa Fe', nameOriginal: 'Santa Fe', country: 'New Mexico', countryOriginal: 'New Mexico', lat: 35.6870, lng: -105.9378 },
            { name: 'Albany', nameOriginal: 'Albany', country: 'New York', countryOriginal: 'New York', lat: 42.6526, lng: -73.7562 },
            { name: 'Raleigh', nameOriginal: 'Raleigh', country: 'North Carolina', countryOriginal: 'North Carolina', lat: 35.7796, lng: -78.6382 },
            { name: 'Bismarck', nameOriginal: 'Bismarck', country: 'North Dakota', countryOriginal: 'North Dakota', lat: 46.8083, lng: -100.7837 },
            { name: 'Columbus', nameOriginal: 'Columbus', country: 'Ohio', countryOriginal: 'Ohio', lat: 39.9612, lng: -82.9988 },
            { name: 'Oklahoma City', nameOriginal: 'Oklahoma City', country: 'Oklahoma', countryOriginal: 'Oklahoma', lat: 35.4676, lng: -97.5164 },
            { name: 'Salem', nameOriginal: 'Salem', country: 'Oregon', countryOriginal: 'Oregon', lat: 44.9429, lng: -123.0351 },
            { name: 'Harrisburg', nameOriginal: 'Harrisburg', country: 'Pennsylvania', countryOriginal: 'Pennsylvania', lat: 40.2732, lng: -76.8867 },
            { name: 'Providence', nameOriginal: 'Providence', country: 'Rhode Island', countryOriginal: 'Rhode Island', lat: 41.8240, lng: -71.4128 },
            { name: 'Columbia', nameOriginal: 'Columbia', country: 'South Carolina', countryOriginal: 'South Carolina', lat: 34.0007, lng: -81.0348 },
            { name: 'Pierre', nameOriginal: 'Pierre', country: 'South Dakota', countryOriginal: 'South Dakota', lat: 44.3683, lng: -100.3510 },
            { name: 'Nashville', nameOriginal: 'Nashville', country: 'Tennessee', countryOriginal: 'Tennessee', lat: 36.1627, lng: -86.7816 },
            { name: 'Austin', nameOriginal: 'Austin', country: 'Texas', countryOriginal: 'Texas', lat: 30.2672, lng: -97.7431 },
            { name: 'Salt Lake City', nameOriginal: 'Salt Lake City', country: 'Utah', countryOriginal: 'Utah', lat: 40.7608, lng: -111.8910 },
            { name: 'Montpelier', nameOriginal: 'Montpelier', country: 'Vermont', countryOriginal: 'Vermont', lat: 44.2601, lng: -72.5754 },
            { name: 'Richmond', nameOriginal: 'Richmond', country: 'Virginia', countryOriginal: 'Virginia', lat: 37.5407, lng: -77.4360 },
            { name: 'Olympia', nameOriginal: 'Olympia', country: 'Washington', countryOriginal: 'Washington', lat: 47.0379, lng: -122.9007 },
            { name: 'Charleston', nameOriginal: 'Charleston', country: 'West Virginia', countryOriginal: 'West Virginia', lat: 38.3498, lng: -81.6326 },
            { name: 'Madison', nameOriginal: 'Madison', country: 'Wisconsin', countryOriginal: 'Wisconsin', lat: 43.0731, lng: -89.4012 },
            { name: 'Cheyenne', nameOriginal: 'Cheyenne', country: 'Wyoming', countryOriginal: 'Wyoming', lat: 41.1400, lng: -104.8202 }
        ],
        major: [
            ...
            { name: 'San Diego', nameOriginal: 'San Diego', country: 'United States', countryOriginal: 'United States', lat: 32.7157, lng: -117.1611 },
            { name: 'Dallas', nameOriginal: 'Dallas', country: 'United States', countryOriginal: 'United States', lat: 32.7767, lng: -96.7970 },
            { name: 'Seattle', nameOriginal: 'Seattle', country: 'United States', countryOriginal: 'United States', lat: 47.6062, lng: -122.3321 }
        ]
    },
    'south-america': {
        capitals: [
